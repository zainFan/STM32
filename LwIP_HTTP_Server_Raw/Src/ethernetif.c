...
#include "../Components/dp83848/lan8742.h"
#include <string.h>
...
#define ETH_RX_BUFFER_CNT           12U     /* This app buffers receive packets of its primary service
                                               * protocol for processing later. */
#define ETH_TX_BUFFER_MAX             ((ETH_TX_DESC_CNT) * 2U) /* HAL_ETH_Transmit(_IT) may attach two
